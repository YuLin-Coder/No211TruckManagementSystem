package com.fh.controller.expense.expense;
...
public class ExpenseController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("EXPENSE_PERSON_ID", "");	//报销人ID
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("expense/expense/expense_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("expense/expense/expense_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("EXPENSE_REMARK"));	    //1
			vpd.put("var2", varOList.get(i).getString("EXPENSE_TYPE"));	    //2
			vpd.put("var3", varOList.get(i).getString("EXPENSE_BEGIN_DATE"));	    //3
			vpd.put("var4", varOList.get(i).getString("EXPENSE_PERSON_NAME"));	    //4
			vpd.put("var5", varOList.get(i).getString("EXPENSE_PERSON_ID"));	    //5
			vpd.put("var6", varOList.get(i).get("EXPENSE_AMOUNT").toString());	//6
			varList.add(vpd);
		}
