package com.fh.controller.leave.leave;
...
import com.fh.service.leave.leave.LeaveManager;
...
public class LeaveController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("leave/leave/leave_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("leave/leave/leave_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("LEAVE_REASON"));	    //1
			vpd.put("var2", varOList.get(i).getString("LEAVE_TYPE"));	    //2
			vpd.put("var3", varOList.get(i).getString("LEAVE_BEGIN_DATE"));	    //3
			vpd.put("var4", varOList.get(i).getString("LEAVE_END_DATE"));	    //4
			vpd.put("var5", varOList.get(i).getString("LEAVE_PERSON_NAME"));	    //5
			vpd.put("var6", varOList.get(i).getString("LEAVE_PERSON_ID"));	    //6
			varList.add(vpd);
		}
