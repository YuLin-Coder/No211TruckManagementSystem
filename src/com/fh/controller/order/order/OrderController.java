...
public class OrderController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("ORDER_NAME"));	    //1
			vpd.put("var2", varOList.get(i).getString("ORDER_TYPE"));	    //2
			vpd.put("var3", varOList.get(i).getString("ORDER_START_ADD"));	    //3
			vpd.put("var4", varOList.get(i).getString("ORDER_END_ADD"));	    //4
			vpd.put("var5", varOList.get(i).get("ORDER_AMOUNT").toString());	//5
			vpd.put("var6", varOList.get(i).getString("ORDER_STATUS"));	    //6
			varList.add(vpd);
		}
