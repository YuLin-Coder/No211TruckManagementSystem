						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">货车名称</th>
									<th class="center">货车类型</th>
									<th class="center">货运金额</th>
									<th class="center">货车状态</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.CAR_NAME}</td>
											<td class='center'>${var.CAR_TYPE}</td>
											<td class='center'>${var.CAR_AMOUNT}</td>
											<td class='center'>${var.CAR_STATUS}</td>
											<td class="center">
