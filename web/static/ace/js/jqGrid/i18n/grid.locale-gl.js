...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Buscar",
	    Reset: "Limpar",
	    odata: [{ oper:'eq', text:"igual "},{ oper:'ne', text:"diferente a"},{ oper:'lt', text:"menor que"},{ oper:'le', text:"menor ou igual que"},{ oper:'gt', text:"maior que"},{ oper:'ge', text:"maior ou igual a"},{ oper:'bw', text:"empece por"},{ oper:'bn', text:"non empece por"},{ oper:'in', text:"est谩 en"},{ oper:'ni', text:"non est谩 en"},{ oper:'ew', text:"termina por"},{ oper:'en', text:"non termina por"},{ oper:'cn', text:"cont茅n"},{ oper:'nc', text:"non cont茅n"},{ oper:'nu', text:'is null'},{ oper:'nn', text:'is not null'}],
