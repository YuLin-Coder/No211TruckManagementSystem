...
$.extend($.jgrid,{
	...
	edit : {
		...
		msg: {
			...
			minValue:"Vrijednost mora biti ve膰a ili identi膷na ",
			maxValue:"Vrijednost mora biti manja ili identi膷na",
	...
	del : {
		caption: "Obri拧i",
		msg: "Obri拧i ozna膷en zapis ili vi拧e njih?",
		bSubmit: "Obri拧i",
		bCancel: "Odustani"
	},
	nav : {
		edittext: "",
		edittitle: "Promijeni obilje啪eni red",
		addtext: "",
		addtitle: "Dodaj novi red",
		deltext: "",
		deltitle: "Obri拧i obilje啪eni red",
		searchtext: "",
		searchtitle: "Potra啪i zapise",
		refreshtext: "",
		refreshtitle: "Ponovo preuzmi podatke",
		alertcap: "Upozorenje",
		alerttext: "Molim, odaberi red",
		viewtext: "",
		viewtitle: "Pregled obilje啪enog reda"
	},
	col : {
		caption: "Obilje啪i kolonu",
		bSubmit: "Uredu",
		bCancel: "Odustani"
	},
	errors : {
		...
		model : "colNames i colModel imaju razli膷itu duljinu!"
	},
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Nedjelja", "Ponedjeljak", "Utorak", "Srijeda", "膶etvrtak", "Petak", "Subota"
			],
			monthNames: [
				"Sij", "Velj", "O啪u", "Tra", "Svi", "Lip", "Srp", "Kol", "Ruj", "Lis", "Stu", "Pro",
